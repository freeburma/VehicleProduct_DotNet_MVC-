...
namespace VehicleProducts.Services
{
	...
	public class RoleServices
    {
		...
		public static async Task CreateRoles(IServiceProvider serviceProvider)
        {
			...
			await GetAndCreateRoles(roleManager); 
		...
		public static async Task GetAndCreateRoles(RoleManager<IdentityRole> roleManager)
        {
		...
		}// end GetAndCreateRoles()


		public static async Task CreateAdminUser(UserManager<IdentityUser> userManager)
		{
			// Preparing to create an admin user 
			string adminUserEmail = "hello@gmail.com";
			string adminUserPassword = "$Password1234";
